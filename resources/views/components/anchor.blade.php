...
@php
    $class = 
        'text-center rounded-lg transition-all duration-200 font-semibold leading-6 hover:cursor-pointer active:translate-y-1 ' .
        match($colors) {
        ...
        match($size) { // Size class
            ...
            'large' => 'text-xl py-2 px-4 sm:text-2xl sm:py-3 sm:px-6 lg:text-3xl lg:py-4 lg:px-8 ',
